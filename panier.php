        ...
        <div class="checkout-section">
                ...
                <div class="cart-table-container">
                    ...
                    <table class="cart-table">
                        ...
                        foreach ($_SESSION['panier'] as $id => $qte):
                            ...
                            $res = mysqli_query(
                                $conn,
                                "SELECT * FROM livre WHERE idLivre = $id"
                            );
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo number_format($l['prix'], 3); ?> DT
                                </td>
                                ...
                                <td style="font-weight:600;">
                                    <?php echo number_format($st, 3); ?> DT
                                </td>
            ...
            <div class="order-summary">
                ...
                <div class="summary-item">
                    ...
                    <span>
                        Articles (<?php echo $nb_articles; ?>)
                    </span>

                    <span>
                        <?php echo number_format($total_ttc * 0.81, 3); ?> DT
                    </span>
                ...
                <div class="summary-item">
                    ...
                    <span>
                        <?php echo number_format($total_ttc * 0.19, 3); ?> DT
                    </span>
                ...
                <div class="total-row">
                    ...
                    <h2>
                        ...
                        <span>
                            <?php echo number_format($total_ttc, 3); ?> DT
                        </span>
